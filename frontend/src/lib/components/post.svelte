  ...
  {#if variant === "thread"}
    ...
    <div class="p-6">
      ...
      <div class="flex gap-5">
        ...
        <div class="flex-1">
          ...
          <div class="flex flex-wrap items-center gap-2 text-sm text-neutral-600 mb-3">
            ...
            {#if solved}
              <span>•</span>
              <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-300">
            ...
            {:else}
              <span>•</span>
              <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-rose-100 dark:bg-rose-900/30 text-rose-800 dark:text-rose-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
          ...
          <h2 class="text-2xl font-semibold mb-3 text-neutral-900 dark:text-white">{title}</h2>
          {#if description}
            <div class="text-neutral-800 dark:text-neutral-200 mb-4 leading-relaxed whitespace-pre-line">
              {description}
            </div>
          {/if}
          ...
          <!-- Post Action Buttons for thread owner - now moved inside the post -->
          {#if currentUser === postedBy}
            <div class="flex items-center gap-2 mt-3">
              ...
              {#if !solved}
                <Button 
                  variant="outline"
                  class="text-xs py-1.5 px-4 border-teal-400 dark:border-teal-600 text-teal-700 dark:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/20 rounded-full"
              ...
              {:else}
                <Button 
                  variant="outline"
                  class="text-xs py-1.5 px-4 border-rose-400 dark:border-rose-600 text-rose-700 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 rounded-full"
      ...
      {#if solved && resolution}
        <div class="mt-4 mb-5 bg-teal-50 dark:bg-teal-900/10 border border-teal-200 dark:border-teal-800/50 rounded-md overflow-hidden">
          <div class="px-5 py-4 flex items-start gap-3">
            ...
            <div class="flex-1">
              <h3 class="font-medium text-lg text-teal-800 dark:text-teal-300 mb-2">Mystery Object Resolved</h3>
              <div class="text-neutral-800 dark:text-neutral-200 mb-3 whitespace-pre-line">
              ...
              {#if resolution.contributingComments && resolution.contributingComments.length > 0}
                <div class="mt-2 border-t border-teal-200 dark:border-teal-800/50 pt-3">
                  <h4 class="text-sm font-medium text-teal-800 dark:text-teal-400 mb-1 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <p class="text-xs text-neutral-600 dark:text-neutral-400">
                    {resolution.contributingComments.length} comment{resolution.contributingComments.length !== 1 ? 's' : ''} helped resolve this mystery
                  </p>
                </div>
              {/if}
            </div>
      ...
      <div class="h-px bg-neutral-200 dark:bg-neutral-800 my-5"></div>
      ...
      {#if mediaFiles.length > 0}
        <div class="lg:w-1/2 flex-shrink-0 order-1 lg:order-2">
          <div class="relative rounded-md overflow-hidden bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 shadow-sm">
            ...
            {#if mediaFiles.length > 1}
              <div class="flex justify-center gap-2 px-4 py-3 bg-neutral-100 dark:bg-neutral-800 overflow-x-auto">
