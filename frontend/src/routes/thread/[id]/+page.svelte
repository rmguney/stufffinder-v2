  ...
  <div class="w-full max-w-7xl mx-auto">
    ...
    <div class="mt-3 mb-3">
      <div class="flex items-center justify-between">
        <h2 class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-neutral-100 dark:bg-neutral-950 text-neutral-800 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5 text-neutral-500" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zM7 8H5v2h2V8zm2 0h2v2H9V8zm6 0h-2v2h2V8z" clip-rule="evenodd" />
          </svg>
          Discussion
        </h2>
        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium bg-neutral-100 dark:bg-neutral-950 text-neutral-800 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">
    ...
    {#if $activeUser}
      <Card.Root class="bg-white dark:bg-neutral-950 shadow-md rounded-md border border-neutral-200 dark:border-neutral-800 mb-4 overflow-hidden">
    ...
    {:else}
      <Card.Root class="bg-white dark:dark:bg-neutral-950 shadow-md rounded-md border border-neutral-200 dark:border-neutral-800 mb-4 overflow-hidden">
    ...
    {#if comments.length > 0}
      <div class="space-y-3">
        {#each comments as commentItem (commentItem.id)}
          <!-- Remove hover animation by changing this div -->
          <div>
            <Comment
              threadId={data.id}
