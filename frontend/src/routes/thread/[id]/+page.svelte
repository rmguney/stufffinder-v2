<script>
  ...
  let threadLoading = true; // Add loading state for thread
  ...
  $: {
    const foundThread = $threadStore.find(t => t.id == data.id);
    threadLoading = !foundThread;
    thread = foundThread;
  }
        ...
        <div class="bg-white dark:bg-neutral-950 shadow-md rounded-md border border-neutral-200 dark:border-neutral-800 overflow-hidden p-4">
          <div class="flex justify-center">
            <div class="flex flex-col items-center">
              ...
              <p class="text-sm text-neutral-500">Loading post details...</p>
            </div>
          </div>
        </div>
      </div>
